...
hi Comment      gui=ITALIC guifg=white   guibg=#a0b0c0
hi Folded       guifg=#708090   guibg=#c0d0e0
hi Folded       guifg=#708090   guibg=#c0d0e0
hi FoldColumn   guifg=#708090   guibg=#c0d0e0

hi Constant     guifg=black guibg=#f6f6f6
hi Number       guifg=black guibg=#f6f6f6
hi Float        guifg=black guibg=#f6f6f6
hi Boolean      guifg=#0048ff guibg=#f6f6f6
"hi String       guifg=#4070a0 gui=none
hi String       guifg=#8090a0 guibg=#f6f6f6  gui=none
