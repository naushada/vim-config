...
"
 ...
 if exists("syntax_on")
     ...
     hi IncSearch    cterm=none ctermbg=blue ctermfg=grey guifg=slategrey
     guibg=khaki
     "hi LineNr      
     ...
     hi Visual   cterm=none ctermbg=darkgreen ctermfg=yellow gui=none
     guifg=khaki guibg=olivedrab
     "hi VisualNOS   
