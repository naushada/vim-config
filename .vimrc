...
if has ("unix")
    let $EX_DEV=$HOME.'/.vim'
    let g:ex_toolkit_path = $HOME.'/.vim/toolkit'
...
let g:ex_usr_name = "Ravi Nathwani"
...
if has("gui_running")
    ...
    " silent exec "colorscheme ironman"
...
nnoremap <unique> <silent> <C-]> :ExtsGoDirectly<CR>
...
nmap <C-\>s :CSS <C-R>=expand("<cword>")<CR><CR>	
nmap <C-\>g :CSG <C-R>=expand("<cword>")<CR><CR>	
nmap <C-\>c :CSC <C-R>=expand("<cword>")<CR><CR>	
nmap <C-\>t :CST <C-R>=expand("<cword>")<CR><CR>	
nmap <C-\>e :CSE <C-R>=expand("<cword>")<CR><CR>	
nmap <C-\>i :CSI <C-R>=expand("<cword>")<CR>$<CR>
nmap <C-\>d :CSD <C-R>=expand("<cword>")<CR><CR>
...
" Function name display in status line
